...
2. 更新PCB信息。
3. 把进程的PCB移入相应的队列，如就绪、在某事件阻-塞等队列。
4. 选择另一个进程执行，并更新其PCB。
5. 更新内存管理的数据结构。
6. 恢复处理机上下文。
...
![clipboard.png](.assets/1593755892-55c466c2b5fc5_articlex.png)
...
![clipboard.png](.assets/1505222224-55c466dda9803_articlex.png)
...
![clipboard.png](.assets/1903235121-55c466eb17665_articlex.png)
...
![clipboard.png](.assets/1311869885-55c466fac00ba_articlex.png)
...
**各个IO Model的比较如图所示：**
![clipboard.png](.assets/2109320510-55c4670795194_articlex.png)
