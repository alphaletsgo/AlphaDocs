...
![img](.assets/944365-e7baca065f885271.png)
...
- `Android`的UI界面由`Activity`、`ViewGroup`、`View`及其派生类组成

  ![img](.assets/944365-ece40d4524784ffa.png)

  

![img](.assets/944365-02c588300f6ad741.png)
...
![img](.assets/944365-7fee82bba19a3821.png)

### 1.5 事件分发过程由哪些方法协作完成？

**答：dispatchTouchEvent() 、onInterceptTouchEvent()和onTouchEvent()**

![img](.assets/944365-7c6642f518ffa3d2.png)

> 下文会对这3个方法进行详细介绍

### 1.6 总结

![img](.assets/944365-d0a7e6f3c2bbefcc.png)
...
![img](.assets/944365-f8fda76bbdad7b96.png)

- 方法总结

![img](.assets/944365-e186b0edcb590546.png)

那么，`ViewGroup`的`dispatchTouchEvent()`什么时候返回`true` / `false`？

请继续往下看**ViewGroup事件的分发机制**
...
![img](.assets/944365-6ec2e864af7ffd37.png)

- 核心方法总结

![img](.assets/944365-ff627fea1a2244ad.png)

### 2.2.3 Demo讲解

- 布局如下

  ![img](.assets/944365-b0bf3dd7ad41b335.png)
...
- 结果测试
  ...
  ![img](.assets/944365-a9c45aa25d12b589.png)
...
![img](.assets/944365-76ce9e8299386729.png)

> 注：`onTouch（）`的执行 先于  `onClick（）`

- 核心方法总结

![img](.assets/944365-762cf45f36858bbd.png)
...
- 测试结果
  ...
  ![img](.assets/944365-97959093583369a0.png)

# 2.4 总结

![img](.assets/944365-eeebede55f55b040.png)
...
![img](.assets/944365-aea821bbb613c195.png)
...
![img](.assets/944365-bccafd3ff8a880ff.png)

- 以方法为核心的图解说明

![img](.assets/944365-9f340a39bdad520e.png)
...
- 已知事件分发过程的核心方法为：`dispatchTouchEvent()`、`onInterceptTouchEvent()` 和 `onTouchEvent()`
  ...
  ![img](.assets/944365-faaf73d0f3eb870f.png)
...
![img](.assets/944365-4fbf11afa24b033b.png)

![img](.assets/944365-f8888a622c255648.png)

- 返回情况说明

**情况1：默认**

![img](.assets/944365-a4582905b3972904.png)



![img](.assets/944365-fee3555bdc6f9524.png)

**情况2：返回true**

![img](.assets/944365-b00acc9f529f5393.png)



![img](.assets/944365-6822b1af27852dbd.png)

**情况3：返回false**

![img](.assets/944365-962fc440d2fffe0b.png)



![img](.assets/944365-0a9ae1bc05f432b9.png)
...
![img](.assets/944365-f4116863606e494e.png)

> 注：`Activity`、`View`都无该方法

![img](.assets/944365-28d0f5e7a1665148.png)

- 返回情况说明

**情况1：true**

![img](.assets/944365-9a83aed00a8c0a54.png)



![img](.assets/944365-6889eda6ebda8c40.png)



**情况2：false（默认）**

![img](.assets/944365-ea06029e3176635f.png)



![img](.assets/944365-299cfcbe3a9c9fd5.png)
...
![img](.assets/944365-b5f527027257b98e.png)

![img](.assets/944365-744f5b7e8d413562.png)

- 返回情况说明

**情况1：返回true**

![img](.assets/944365-36af591c11a8e450.png)



![img](.assets/944365-aef94c6c182353a9.png)

**情况2：返回false（default）**

![img](.assets/944365-efd21a46a9af808e.png)



![img](.assets/944365-5da9fe2990f75d9c.png)
...
![img](.assets/944365-e0f526dd1b5731be.png)
...
![img](.assets/944365-161a6e6fc8723248.png)
...
![img](.assets/944365-77e933eb44682777.png)
...
![img](.assets/944365-a5e7cfed2cba02c3.png)
...
![img](.assets/944365-1599f532038686cd.png)
...
![img](.assets/944365-93d0b1496e9e6ca4.png)
...
![img](.assets/944365-9d639a0b9ebf7b4a.png)
